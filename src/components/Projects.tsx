  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center gap-20 px-96 bg-gray-100">
      ...
      <div
        ...
        data-aos="zoom-in"
        className="shadow-xl hover:!shadow-2xl hover:!transition-shadow hover:!duration-300 flex flex-col justify-between items-center gap-5 border border-blue-900 p-5 size-1/2 h-fit rounded-2xl"
      >
        <img
          alt="kheradkhan"
          src="/kheradkhan.png"
