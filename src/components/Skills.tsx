...
function Skills() {
  return (
    <div className="py-20 min-h-screen flex flex-col items-center justify-center gap-10 md:gap-20 px-5 md:px-20 lg:px-40">
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-20">
        ...
        <div
          ...
          className="shadow-xl hover:!shadow-2xl hover:!transition-shadow hover:!duration-300 flex flex-col items-center justify-center gap-8 border border-blue-900 rounded-2xl p-5 md:py-5 md:px-8"
        >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-10">
            {[
              ...
              <div key={index} className="flex items-center gap-4">
                <MdVerified className="text-xl md:text-2xl" />
                <div className="flex flex-col items-start">
                  <p className="text-lg md:text-2xl font-bold">{skill.name}</p>
                  <p>{skill.level}</p>
                </div>
